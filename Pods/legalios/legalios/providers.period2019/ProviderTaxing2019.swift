...
class ProviderTaxing2019: ProviderTaxing {
    init() {
        super.init(versionId: HistoryConstTaxing2019.VERSION_CODE)
    }
    ...
    override func marginIncomeOfWthEmp(_ period: IPeriod) -> Int32 {
        if (IsPeriodGreaterOrEqualThan(period: period, yearFrom: 2019, monthFrom: 5)) {
