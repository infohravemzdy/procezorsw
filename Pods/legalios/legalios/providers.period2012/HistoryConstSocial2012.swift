...
struct HistoryConstSocial2012
{
    static let VERSION_CODE: Int16 = 2012

    static let MAX_ANNUALS_BASIS: Int32 = 1206576
    static let FACTOR_EMPLOYER: Decimal = HistoryConstSocial2011.FACTOR_EMPLOYER
    static let FACTOR_EMPLOYER_HIGHER: Decimal = HistoryConstSocial2011.FACTOR_EMPLOYER_HIGHER
    static let FACTOR_EMPLOYEE: Decimal = HistoryConstSocial2011.FACTOR_EMPLOYEE
    static let FACTOR_EMPLOYEE_REDUCE: Decimal = HistoryConstSocial2011.FACTOR_EMPLOYEE_REDUCE
    static let FACTOR_EMPLOYEE_GARANT: Decimal = HistoryConstSocial2011.FACTOR_EMPLOYEE_GARANT
