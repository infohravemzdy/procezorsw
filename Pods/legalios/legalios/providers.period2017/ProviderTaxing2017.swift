...
class ProviderTaxing2017: ProviderTaxing {
    init() {
        super.init(versionId: HistoryConstTaxing2017.VERSION_CODE)
    }
    ...
    override func allowanceChild2nd(_ period: IPeriod) -> Int32  {
        if (IsPeriodGreaterOrEqualThan(period: period, yearFrom: 2017, monthFrom: 7)) {
