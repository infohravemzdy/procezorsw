...
class ProviderTaxing2016: ProviderTaxing {
    init() {
        super.init(versionId: HistoryConstTaxing2016.VERSION_CODE)
    }

    override func getProps<P>(_ period: IPeriod) -> P {
        return PropsTaxing2014(version: version,
    ...
    override func allowanceChild2nd(_ period: IPeriod) -> Int32  {
        if (IsPeriodGreaterOrEqualThan(period: period, yearFrom: 2016, monthFrom: 5)) {
